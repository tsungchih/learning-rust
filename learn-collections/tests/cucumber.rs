...
mod example_steps {
    ...
    // The steps! macro generates a function named steps with all the declared steps in the module it is defined in. 
    // Ordinarily you would create something like a steps/ directory to hold your steps modules instead of inline like the given example.
    steps!(::MyWorld => {
